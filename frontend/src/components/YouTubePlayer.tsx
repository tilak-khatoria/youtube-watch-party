...
export const YouTubePlayer: React.FC<YouTubePlayerProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col w-full h-full glass-elevated rounded-2xl overflow-hidden shadow-2xl relative group"
    >
      ...
      <div className="relative w-full flex-1 min-h-[300px] bg-black flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-30 flex items-center gap-2 pointer-events-none">
          {isHost && (
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-950/80 border border-amber-500/40 text-amber-200 text-xs font-bold backdrop-blur-md shadow-lg shadow-amber-950/30">
              <Sparkles className="w-3.5 h-3.5 text-amber-400" />
              <span>Host Controller Active</span>
            </div>
          )}
          {isModerator && (
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-cyan-950/80 border border-cyan-500/40 text-cyan-200 text-xs font-bold backdrop-blur-md shadow-lg shadow-cyan-950/30">
      ...
      <div className="p-3.5 bg-white/60 dark:bg-slate-900/60 border-t border-white/10 dark:border-white/10 backdrop-blur-md flex flex-col gap-2.5 z-30 transition-colors">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            {isHostOrModerator ? (
              ...
              <div
                className="glass-base flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-slate-500 dark:text-slate-400 text-xs font-medium cursor-not-allowed"
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="glass-base flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all hover:scale-105 shadow-sm cursor-pointer"
            ...
            {isHostOrModerator && (
              <button
                ...
                className="glass-base flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 hover:text-slate-950 dark:hover:text-white hover:border-indigo-500/40 hover:scale-105 shadow-sm transition-all cursor-pointer"
              >
